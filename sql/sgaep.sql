...
--
-- Servidor: localhost
-- Tiempo de generación: 27-11-2017 a las 02:55:47
...
--
-- Estructura de tabla para la tabla `tableBooleanQuestions`
--

CREATE TABLE `tableBooleanQuestions` (
...
--
-- Volcado de datos para la tabla `tableBooleanQuestions`
--
...
--
-- Estructura de tabla para la tabla `tableMultipleQuestions`
--

CREATE TABLE `tableMultipleQuestions` (
...
--
-- Volcado de datos para la tabla `tableMultipleQuestions`
--
...
--
-- Estructura de tabla para la tabla `tableOpenQuestions`
--

CREATE TABLE `tableOpenQuestions` (
...
--
-- Volcado de datos para la tabla `tableOpenQuestions`
--
...
--
-- Estructura de tabla para la tabla `tableQuestions`
--
...
--
-- Volcado de datos para la tabla `tableQuestions`
--
...
--
-- Estructura de tabla para la tabla `tableSubjects`
--
...
--
-- Volcado de datos para la tabla `tableSubjects`
--
...
--
-- Estructura de tabla para la tabla `tableUsers`
--
...
--
-- Volcado de datos para la tabla `tableUsers`
--
...
--
-- Indices de la tabla `tableBooleanQuestions`
--
ALTER TABLE `tableBooleanQuestions`
  ADD PRIMARY KEY (`vcIdQuestion`);

--
-- Indices de la tabla `tableMultipleQuestions`
--
ALTER TABLE `tableMultipleQuestions`
  ADD PRIMARY KEY (`vcIdQuestion`);

--
-- Indices de la tabla `tableOpenQuestions`
--
ALTER TABLE `tableOpenQuestions`
  ADD PRIMARY KEY (`vcIdQuestion`);

--
-- Indices de la tabla `tableQuestions`
--
...
--
-- AUTO_INCREMENT de la tabla `tableQuestions`
--
ALTER TABLE `tableQuestions`
